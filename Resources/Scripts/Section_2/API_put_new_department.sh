...
curl -su "$jamfpro_username":"$jamfpro_password" -H "content-type: application/xml" "$jamfpro_url"/JSSResource/departments/id/0 -X POST -d "<department><name>MN Vikings Rule</name></department>"